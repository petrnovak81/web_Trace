...
{ 'field': 'DateOSNPlane', 'template': '#=planeCalendar((rr_State > 29 && rr_State < 40), "DateOSNPlane")#', 'headerTemplate': headerTemplate('@Html.Raw(Language.A2_SeznamDluzSpisyOSN_VisitDateDNPlan)'), 'title': '@Html.Raw(Language.A2_SeznamDluzSpisyOSN_VisitDateDNPlan)', 'width': 100 },
