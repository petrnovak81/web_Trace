<div id="SVPotvrditAVratit" 
    data-role="window"
    data-title="@Html.Raw(Language.Key_ReseniZadostiOVraceniSpisu)"
    data-modal="true"
    data-resizable="true"
    data-actions="['close']"
    style="display: none;width: 400px">
    <span>@Html.Raw(Language.SVPotvrditAVratitTXT1)</span>
    <ul class="fieldlist">
        <li>
            <input type="radio" value="1" data-bind="checked: Open, events: { change: UzavreniSpisu }" class="k-radio" id="SVPotvrditAVratit_radio1" name="SVPotvrditAVratit" /><label for="SVPotvrditAVratit_radio1" class="k-radio-label">@Html.Raw(Language.SVPotvrditAVratitTXT2)</label>
            <div style="margin-left:30px;margin-top:8px;" data-bind="visible: UzavreniSpisu_visible">
                <span>@Html.Raw(Language.SVPotvrditAVratitTXT3)</span>
        ...
        <li>
            <input type="radio" value="2" data-bind="checked: Open, events: { change: ZpetOSN }" class="k-radio" id="SVPotvrditAVratit_radio2" name="SVPotvrditAVratit" /><label for="SVPotvrditAVratit_radio2" class="k-radio-label">@Html.Raw(Language.SVPotvrditAVratitTXT4)</label>
        ...
        <li>
            <input type="radio" value="3" data-bind="checked: Open, events: { change: KeZprac }" class="k-radio" id="SVPotvrditAVratit_radio3" name="SVPotvrditAVratit" /><label for="SVPotvrditAVratit_radio3" class="k-radio-label">@Html.Raw(Language.SVPotvrditAVratitTXT5)</label>
...
<script>
    function SVPotvrditAVratit(ids, callback) {
        var win;
            ...
            Save: function (e) {
                ...
                switch (that.get("Open")) {
                    case "1":
                        ...
                        promises = ids.map(function (id, i) {
                            return $.Deferred(function (d) {
                                $.get("@Url.Action("sp_Do_Super2_3_8_Radio1", "Api/AdminService")", {
                                    iDSpisu: id,
                    ...
                    case "2":
                        ...
                        promises = ids.map(function (id, i) {
                            return $.Deferred(function (d) {
                                $.get("@Url.Action("sp_Do_Super2_3_8_Radio2", "Api/AdminService")", {
                                    iDSpisu: id,
                    ...
                    case "3":
                        ...
                        //sp_Do_Super2_3_8_Radio3(
                        //iDSpisu As Nullable(Of Integer),
                        //comment1 As String, 
                        //rr_CaseNextActivity As Nullable(Of Short), 
                        //commentJine As String, 
                        //datumDeadLine As Nullable(Of Date))
                        promises = ids.map(function (id, i) {
                            return $.Deferred(function (d) {
                                $.get("@Url.Action("sp_Do_Super2_3_8_Radio3", "Api/AdminService")", {
                                    iDSpisu: id,
        ...
        kendo.bind($("#SVPotvrditAVratit"), model);
        win = $("#SVPotvrditAVratit").data("kendoWindow");
        win.open().center();
    };
</script>