<div id="SpisyDL" style="height: 100%; width: 100%;"  data-bind="source: SpisyDL, events: { dataBound: SpisyDL_dataBound, change: SpisyDL_change, detailInit: SpisyDL_detailInit }"></div>
<script>
