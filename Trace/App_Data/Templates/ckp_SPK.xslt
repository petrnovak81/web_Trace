...
<body style="font-family:Arial, Helvetica, sans-serif;font-size:11pt;">
        <div>
          ...
          <p style="text-align:justify;margin: 0cm; margin-bottom: .0001pt; font-family:'Arial',serif;font-size:13pt;margin: 20px;">
            <b>Uznávám svůj dluh vůči věřiteli České kanceláři pojistitelů</b>, Na Pankráci 1724/129, 140 00 Praha 4,IČ: 70099618, v částce <xsl:value-of select="UZSK/ActualDebit" /> Kč, která je složena z jistiny ve výši <xsl:value-of select="UZSK/Principal" /> Kč a příslušenství ve výši <xsl:value-of select="UZSK/InterPenal" /> Kč sestávajícího ze zákonného úroku z prodlení vyčísleného ke dni <xsl:value-of select="ms:format-date(UZSK/SYS_Date, 'dd. MM. yyyy')" /> a nákladů spojených s uplatněním pohledávky.
          </p>
          <p style="text-align:justify;margin: 0cm; margin-bottom: .0001pt; font-family:'Arial',serif;font-size:13pt;margin: 20px;">
          ...
          <p style="text-align:justify;margin: 0cm; margin-bottom: .0001pt; font-family:'Arial',serif;font-size:13pt;margin: 20px;">
            ...
            </B> vedeného u Citibank, a.s. Praha, pod variabilním symbolem <B>
        ...
        <div>
          ...
          <p style="text-align:justify;margin: 0cm; margin-bottom: .0001pt; font-family:'Arial',serif;font-size:13pt;margin: 20px">
            <B>Věřitel:</B> Česká kancelář pojistitelů, Na Pankráci 1724/129, 140 00 Praha 4, IČ: 70099618
          </p>
          <p style="text-align:justify;margin: 0cm; margin-bottom: .0001pt; font-family:'Arial',serif;font-size:13pt;margin: 20px">
